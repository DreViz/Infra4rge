...
const CATEGORY_CONFIG = {
  ...
  database: {
    ...
    bar: "bg-gradient-to-r from-blue-500 to-blue-400/70",
    badge: "cyan" as const,
  },
  network: {
    label: "Network",
    ...
    bar: "bg-gradient-to-r from-pink-500 to-pink-400/70",
    badge: "default" as const,
  },
  storage: {
    label: "Storage",
    ...
    bar: "bg-gradient-to-r from-yellow-500 to-yellow-400/70",
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex flex-col items-end gap-1.5">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-muted-foreground">{estimate.region}</span>
            </div>
        ...
        <div className="mt-4 flex h-2 rounded-full overflow-hidden gap-0.5 bg-muted/30">
          {estimate.resources.map((r, i) => {
            ...
            const colors: Record<string, string> = {
              compute: "bg-gradient-to-r from-primary to-primary/70",
              database: "bg-gradient-to-r from-blue-500 to-blue-400/70",
              network: "bg-gradient-to-r from-pink-500 to-pink-400/70",
              storage: "bg-gradient-to-r from-yellow-500 to-yellow-400/70",
              other: "bg-muted",
            };
            return pct > 1 ? (
              <div
                key={i}
                className={cn("h-full rounded-sm transition-all", colors[r.category] ?? "bg-muted")}
                style={{ width: `${pct}%` }}
            ...
            return (
              <div key={category}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-muted-foreground">${catTotal.toFixed(2)}/mo</span>
                </div>
          ...
          {estimate.optimizations.length > 0 && (
            <div className="pt-2 border-t border-border/40">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-xs font-medium text-muted-foreground">Cost Optimizations</p>
              </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4">
      ...
      <div className="flex flex-col items-center gap-1">
        <p className="text-sm font-medium text-foreground">Estimating costs...</p>
        <p className="text-xs text-muted-foreground">Analyzing your Terraform resources</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 px-8">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        <h3 className="text-sm font-semibold text-foreground">Cost Estimation</h3>
...
function ErrorState({ message }: { message: string }) {
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 px-8">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        <h3 className="text-sm font-semibold text-foreground">Estimation failed</h3>
